...
void	NinjaTrap::set_energy_points(unsigned i) {
	_energy_points = i;
}

void	NinjaTrap::set_max_energy_points(unsigned i) {
	_max_energy_points = i;
}

void	NinjaTrap::set_melee_attack_damage(unsigned i) {
	_melee_attack_damage = i;
}
